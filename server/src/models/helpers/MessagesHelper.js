const MESSAGES = {
  ...
  apiErrorStrings: {
    ...
    INVALID_ACTION :'Invalid Action Executed',
    ...
    Product_EXISTS: (data) => `${data} is already in cart.`,
    DATA_NOT_EXISTS :(data) =>`${data} doesn't exists`,
  ...
  apiSuccessStrings: {
    ...
    SIGNUP_SUCCESS_VerifyEmail: 'User registered Very the Email',
    ...
    PLACED: (data) => `${data} placed successfully`,
