...
let TagsService = class TagsService {
    constructor(http) {
        ...
        this.routes = {
            ...
            getAllPath: (params) => `/tag/getAll?page=${params.page}&pageSize=${params.pageSize}&search=${params.search}`,
...
TagsService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
        providedIn: 'root',
    })
], TagsService);
...
let UserService = class UserService {
    ...
    getAllUsers(params) {
        return this.http
            ...
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)((res) => res.result));
    }
