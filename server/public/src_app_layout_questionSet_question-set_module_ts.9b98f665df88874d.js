...
let QuestionSetListComponent = class QuestionSetListComponent {
    constructor(router, questionSetService, seminarService, modalService, toastService, spinner) {
        this.router = router;
        this.questionSetService = questionSetService;
        this.seminarService = seminarService;
    ...
    copyQuestionSet(id) {
        ...
        this.questionSetService.duplicateQuestionSet(payload).subscribe((success) => {
...
QuestionSetListComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
QuestionSetModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        imports: [_question_set_routing_module__WEBPACK_IMPORTED_MODULE_2__.QuestionSetRoutingModule, _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_6__.NgSelectModule, _core_core_module__WEBPACK_IMPORTED_MODULE_3__.CoreModule.forRoot()],
    })
], QuestionSetModule);
