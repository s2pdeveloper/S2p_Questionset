...
let UserListComponent = class UserListComponent {
    ...
    getAll() {
        ...
        this.userService.getAllUsers(params).subscribe((success) => {
            ...
            this.users = success === null || success === void 0 ? void 0 : success.data;
            this.collection = success === null || success === void 0 ? void 0 : success.totalCount;
            this.spinner.hide();
        }, (error) => {
            this.spinner.hide();
...
//# sourceMappingURL=src_app_layout_users_users_module_ts.96a2b3e7becc51c7.js.map